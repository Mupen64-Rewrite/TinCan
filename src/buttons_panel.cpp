...
namespace tasinput {
  ...
  ButtonsPanel::ButtonsPanel(wxWindow* parent) :
    ...
    btnL(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "L", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnZ(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "Z", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnR(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "R", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),

    lblD(new wxStaticText(szrRoot->GetStaticBox(), wxID_ANY, "D")),
    btnDU(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "^", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnDD(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "v", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnDL(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "<", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnDR(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, ">", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),

    btnStart(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "S", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnB(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "B", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnA(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "A", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),

    lblC(new wxStaticText(szrRoot->GetStaticBox(), wxID_ANY, "C")),
    btnCU(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "^", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnCD(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "v", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    btnCL(new wxToggleButton(
      szrRoot->GetStaticBox(), wxID_ANY, "<", wxDefaultPosition, wxDefaultSize,
      wxBU_EXACTFIT)),
    ...
    gridSizer->Add(lblD, {2, 1}, wxDefaultSpan, wxALIGN_CENTER);
    ...
    gridSizer->Add(lblC, {2, 7}, wxDefaultSpan, wxALIGN_CENTER);
