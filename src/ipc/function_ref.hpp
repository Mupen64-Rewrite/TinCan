...
namespace tl {
  namespace detail::fnref {
    ...
    /**
     * Tags a member function for use in a tl::function_ref.
     * @tparam TMF type of the member function.
     * @tparam MF the member function.
     */
    template <class TMF, TMF MF>
    struct memfn_tag {};

#define TL_FNREF_MEMFN_TAG(FN) tl::memfn_tag<decltype(FN), FN>
...
/// A lightweight non-owning reference to a callable.
  ...
  public:
    ...
    // Constructor using a member function provided at compile time.
    template <typename C, R (C::* MF)(Args...)>
    TL_FUNCTION_REF_11_CONSTEXPR function_ref(const C& obj, tl::memfn_tag<R (C::*)(Args...), MF>)
